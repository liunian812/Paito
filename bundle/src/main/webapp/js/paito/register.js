...
function checkAccountName(){
    ...
    if(!usAccount_pattern.test(usAccount)){
        ...
        $.post('/validate/checkAccount.action?usAccount='+usAccount, null, function(data){
            if(data.info.ok){
                $("#name_err_fir").hide();
                $("#name_err_sec").hide();
                $("#name_suc").show();
